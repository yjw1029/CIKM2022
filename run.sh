...
out_path=/home/v-chaozhang/model/gin_cikm2022-fix_maxs_100_se_0_hi_${hidden}_maxd_${max_depth}_po_${pooling}
echo ${out_path}
echo ${gpu}
...
--device ${gpu} --clients 7  --clients-per-step 1 --patient 30 
